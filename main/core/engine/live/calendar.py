...
本模块为 live 专属（仅 LiveEngine 及其协作者使用，回测不依赖），故归入
core.engine.live 子包。原路径 core.engine.trading_calendar 保留 re-export shim，
外部 import 路径与测试直连无需改动。
"""
...
logger = logging.getLogger("core.engine.live.calendar")
